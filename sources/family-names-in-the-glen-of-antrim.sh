...
Unfortunately, there not so much on Galbraith. The index lists three entries, which point to a transcription of Hearth Tax records from 1666-1669, mostly under the name McBritany. No expository text.

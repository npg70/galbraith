...
$ul{
	...
	$li{$source-link[argyll-courts-v1]{Argyll Courts V1}}
	$li{$source-link[argyll-courts-v2]{Argyll Courts V2}}
	$li{$source-link[argyll-courts-v3]{Argyll Courts V3}}
	$li{$source-link[argyll-courts-v4]{Argyll Courts V4}}
}
...
$ul{
	...
	$li{$source-link[kintyre-magazine-19]{Kintyre Magazine #19}, "One Hundred & Eleven Years Ago"}
	$li{$source-link[kintyre-magazine-23]{Kintyre Magazine #23}, "The Blues of North Kintyre"}
	$li{$source-link[kintyre-magazine-28-a]{Kintyre Magazine #28}, "James Nicol Fleming of Keil"}
	$li{$source-link[kintyre-magazine-28-b]{Kintyre Magazine #28}, "The McShannons of Kintyre: Harpers to Tacksmen"}

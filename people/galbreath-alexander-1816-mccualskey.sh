...
partner {
    ...
    birth -date 6-may-1815 -location Lochgilphead
    baptism -date 8-may-1815 -location campbeltown
    death -date 1904 -location Parkersburg,Wood,West Virginia,USA"

    body {
    daugbhter of Alexander McCualskey, b ~1778 from Alexander jr b. 1730 & Margaret McNaught b. 1734 in Campbeltown 4, and Margaret Raeside/Ryside, b. 1787 "Formerly a weaver's wife".
    }

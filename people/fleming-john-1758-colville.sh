...
footnotes {
    ...
    james1791-baptism {
        ...
        $blockquote{
            James Lawful Son to John Fleeming Farmer in Kilman +
            Jean Colvill was borth 9th + bapt 12th Dec.
        }
    }
    robert1793-baptism {
        $opr-ref-link[b-1793-507-000-0040-0109 "Robert Fleeming"]
        $blockquote{
            Robert Lawfull son to John Fleeming + Jean Colville
            Kell??? born 11th bapt 12th
        }
    }
    john1795-baptism {
	$opr-ref-link[b-1795-507-000-0040-0132 "John Fleeming"]
	$blockquote{
		John Lawful son to John Fleeming & Jean Colvill
		in Killowan born 28th bapt 30th

 	}
    }
    janet1799-baptism {
	$opr-ref-link[b-1799-507-000-0040-0193 "Janet Fleeming"]
	$blockquote{
		Janet | John Fleeming & Jean Colvill in Killowan had a lawful
		Daur. born 12th Baptized 14th Called - Janet 
	}
    }
    agnes1802-baptism {
	$opr-ref-link[b-1802-507-000-0040-0225 "Agnes Fleeming"]
	$blockquote{
		Agnes | John Fleeming . Jean Colvill in Killowan had a lawful
		Daur. born 3rd Baptized 6th - named Agnes.
	}
    }
    david1811-baptism {
	$opr-ref-link[b-1811-507-000-0040-0374 "David Fergus Fleeming"]
	$blockquote{
		David Fergus | Lawful Son to John Fleeming Farmer Killeowan 
		and Jean Colville born 18th baptized 24th Sept 1811. David Fergus
	}
    }
    isabell1814-baptism {
	$opr-ref-link[b-1814-507-000-0040-0409 "Isabell Fleeming"]
	$blockquote{
		Isabell | Lawful Daughter to John Fleeming Farmer Killeowan 
		and Jean Colvill born 13th baptized 17th Febry 1814 named Isabell
	}
    }
    isabell1817-baptism {
	$opr-ref-link[b-1817-507-000-0040-0457 "Isabell Fleeming"]
	$blockquote{
		
		Isabell | Lawful Daughter to John Fleeming Farmer Achinleek 

...
todo {
    Census 1891: https://www.findmypast.com/transcript?id=GBC/1891/0035194337&expand=true
}
birth -date 13-aug-1863 -location glasgow -ref alexander1863-birth
partner {
    name Elizabeth Davie MacPherson
    birth -date 30-jul-1860 -location greenock -note 'daughter of Duncan McPherson and Elizabeth Wilson Davie'

...
partner {
    ...
    child {
        name James Mitchell
        baptism -date 8-Jan-1815 -location campbeltown
    }
    child {
        name Robert Mitchell
        baptism -date 3-Nov-1816 -location campbeltown
    }
    child {
        name Janet Mitchell
        baptism -date 23-Dec-1818 -location campbeltown
    }
    child {
        name Jean Mitchell
...
footnotes {
    death {
        $sp-ref-link[d-1859-507-00-0115 0039 "Janet Galbraith"]
    }
    marriage {

...
death -date 28-jan-1880 -location Jura -ref lachlan1799-death
external {
    familysearch KH84-96W
}
tags Argyll:Colonsay Argyll:Jura 'Daughtered Out'
partner {
    ...
    child {
        name Niel Galbraith
        baptism -date 25-jun-1836 -location jura -ref niel1836-baptism
...
footnotes {
    lachlan1799-death {
        $sp-ref-link[d-1880-539-01-0001 0001 "Lachlan Galbraith"]{
        Name: Lachlan Galbraith, Crofter, (Widower of Margaret Lindsay);
        Age: 81 $i{birth 1799};
        Father: Neil Galbraith, laborer (deceased);
        Mother: Jessie Cameron (deceased);
        }
    }

...
partner {
    ...
    child {
        ...
        death -date 24-jun-1878 -location gigha -ref catherine1811-death
        partner {
            name Neil Clark
            marriage -date 27-jun-1853 -location gigha -ref clark-marriage
        }
    }
    child {
        name Mary Galbreath
        baptism -date 01-Oct-1812 -location gigha -ref mary1812-baptism
        death -date 1893 -location gigha -ref mary1812-death -note unmarried
    }
    child {
        name Merran Galbreath
        baptism -date 13-may-1815 -location gigha -ref merran1815-baptism
    }
    child {
...
footnotes {
    ...
    catherine1811-baptism {
        $opr-ref[b-1811-537-000-0010-0046 "Catherine Galbreath"]
    }
    catherine1811-death {
        $sp-ref-link[d-1878-537-00-0003 0001 "Catherine Galbraith"]
    }   
    clark-marriage {
        $opr-ref-link[m-1843-537-000-0020-0051 "Catharien Galbreath" "Neill Clarke"]
    }
    mary1812-baptism {
        $opr-ref[b-1812-537-000-0010-0049 "Mary Galbreath"]
    }
    mary1812-death {
        $sp-ref[d-1893-537-00-0001 "Mary Galbraith"]
    }
    merran1815-baptism {
        $opr-ref[b-1815-537-000-0010-0053 "Merran Galbreath"]
    }   
    duncan1817-baptism {
        $opr-ref[b-1817-537-000-0010-0057 "Duncan Galbreath"]
    }
    duncan1817-death {

...
footnotes {
    james1875-birth {
        $sp-ref-link[b-1875-507-00-0113 0038 "James Duncan Galbraith"], originally listed has "Allan", they filled a RCE changing the name to "James Duncan".  THe next child was named Allan.
    }
    james1875-death {
        $sp-ref-link[d-1943-507-00-0018 0006 "James Duncan McDermid Galbraith"]
    }
    stewart-marriage {

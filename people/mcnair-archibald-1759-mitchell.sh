...
partner {
    ...
    child {
        ...
        death -date 15-April-1884 -location 'New Richmond, Bonaventure, Quebec, Canada'
        partner {
            name John Jamieson
            gender male
...
footnotes {
    mitchell-marriage {
        $opr-ref-link[m-1787-507-000-0020-0170 "Archibald McNair" "Margaret Mitchell"]{
            Archd McNair & Mary Mitchell both of this parish contracted

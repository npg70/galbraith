...
partner {
	...
	marriage -date 20-oct-1746 -location campbeltown -ref fleeming-marriage
	
	child {
		name Daniel Farquharson
		gender male
		baptism -date 22-sep-1747 -location campbeltown -ref dan1747-baptism
	}
	child {
		name Francis Farquharson
		gender male
	...
	child {
		name William Farquharson
		gender male
		baptism -date 28-apr-1753 -location campbeltown -ref william1753-baptism
	}
	child {
		name Janet Farquharson
		gender female
		baptism -date 06-oct-1754 -location campbeltown -ref janet1754-baptism
	}
}
...
partner {
	...
	child {
		...
		gender female
		baptism -date 01-jul-1757 -location campbeltown -ref margaret1757-baptism
	}
	child {
		name Ann Farquharson
		gender female
		baptism -date 25-jun-1758 -location campbeltown -ref ann1758-baptism
	}
	child {
		name Thomas Farquharson
		gender male
...
footnotes {
	...
	fleeming-marriage {
		$opr-ref-link[m-1746-507-000-0011-0449 "Francis Farqrson" "Agnes Fleeming"]{
			[1746] Francis Fargrson + Agnes Fleeming | Oct 20th
		}
	}
	...
	margaret1757-baptism {
		$opr-ref-link[b-1758-507-000-0011-0306 "Margaret Farquharson"]{
		Margaret | Francis Farquharson & Eliz. Frazer had a daughter
		baptized 1st July named Margaret [1757]
		}
		$opr-ref[b-1757-507-000-0010-0233 "Margaret Farqrson"]
	}
	ann1758-baptism {
		$opr-ref[b-1758-507-000-0011-0310 "Ann Farquharson"]
		$opr-ref-link[b-1758-507-000-0010-0238 "Ann Farqrson"]
	}
	thomas1760-baptism {
		$opr-ref[b-1760-507-000-0011-0320 "Thomas Farquharson"]
		$opr-ref[b-1760-507-000-0010-0250 "Thomas Farguharson"]
	}
	john1764-baptism {
		$opr-ref-link[b-1764-507-000-0011-0338 "John Farquharson"]{
		John | Francis Farquharson and Eliz. Frazer has a son
		born + baptized 16th Janry named John [1764]	
		}
		$opr-ref[b-1764-507-000-0010-0280 "John Farquharson"]
	}
}

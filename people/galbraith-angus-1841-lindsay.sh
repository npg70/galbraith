...
footnotes {
    ...
    angus1841-death {
        $sp-ref-link[d-1876-694-00-0024 0008 "Angus Galbraith"]
    }
    lindsay-marriage {
        $sp-ref[m-1867-644-06-0310 "Angus Galbraith" "Jane Lindsay"]
    }
    archibald1868-birth {
        $sp-ref[b-1868-644-08-0811 "Archibald Lindsay Galbraith"]
    }
    jane1869-birth {
        $sp-ref[b-1869-644-06-0628 "Jane Lawrie Galbraith"]
    }
    angus1871-birth {
        $sp-ref[b-1871-694-00-0034 "Angus Galbraith"]
    }
    alexander1873-birth {
        $sp-ref[b-1873-694-00-0025 "Alexander Galbraith"]
    }
    william1875-birth {
        $sp-ref[b-1875-694-00-0022 "William Wilson Galbraith"]
    }
    john1876-birth {
        $sp-ref[b-1876-694-00-0060 "John Galbraith"]
    }
}
